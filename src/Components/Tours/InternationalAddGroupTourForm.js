...
const AddGroupTour = () => {
  ...
  // =======================
  // DEPARTURES FOR GROUP TOURS - NO DESCRIPTION FIELD
  // =======================
  ...
  // Add this useEffect to set initial prefilled content for international tours with Option 1/Option 2
  useEffect(() => {
    if (!isEditMode) {
  ...
  // DEPARTURE FORM CHANGE - Group (NO DESCRIPTION FIELD)
  ...
  return (
    <Navbar>
      <Container>
        <h2 className="mb-4">{isEditMode ? 'Edit International Group Tour' : 'Add International Group Tour'}</h2>
          ...
          <Card.Body>
            ...
            >
              ...
              <Tab eventKey="departures" title="Departures & Costs">
                <div>
                  {/* Departure Dates Section - NO DESCRIPTION FIELD */}
                  <Row className="mb-4">
