...
const [extendableRow, setExtendableRow] = useState({
  ...
  // =======================
  // DEPARTURES FOR GROUP TOURS - UPDATED STRUCTURE
  // =======================
...
const handleTouristVisaChange = (e) => {
 ...
 useEffect(() => {
  ...
  // Load tour data for editing - UPDATED FOR GROUP TOUR STRUCTURE
  const loadTourData = async () => {
    try {
      ...
      const response = await fetch(`${baseurl}/api/tours/tour/full/group/${id}`);
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          tour_type: basic.tour_type || 'Group',
          title: basic.title || '',
        ...
        // Set departures - Group tours have different structure with hotel star ratings
...
if (data.images && Array.isArray(data.images)) {
  ...
  const handleAddDeparture = () => {
    ...
    const departureData = {
      ...
      three_star_twin: groupDepartureForm.three_star_twin || null,
      three_star_triple: groupDepartureForm.three_star_triple || null,
      three_star_child_with_bed: groupDepartureForm.three_star_child_with_bed || null,
      three_star_child_without_bed: groupDepartureForm.three_star_child_without_bed || null,
      three_star_infant: groupDepartureForm.three_star_infant || null,
      three_star_single: groupDepartureForm.three_star_single || null,
      four_star_twin: groupDepartureForm.four_star_twin || null,
      four_star_triple: groupDepartureForm.four_star_triple || null,
      four_star_child_with_bed: groupDepartureForm.four_star_child_with_bed || null,
      four_star_child_without_bed: groupDepartureForm.four_star_child_without_bed || null,
      four_star_infant: groupDepartureForm.four_star_infant || null,
      four_star_single: groupDepartureForm.four_star_single || null,
      five_star_twin: groupDepartureForm.five_star_twin || null,
      five_star_triple: groupDepartureForm.five_star_triple || null,
      five_star_child_with_bed: groupDepartureForm.five_star_child_with_bed || null,
      five_star_child_without_bed: groupDepartureForm.five_star_child_without_bed || null,
      five_star_infant: groupDepartureForm.five_star_infant || null,
      five_star_single: groupDepartureForm.five_star_single || null
    };
...
// UPDATE EXISTING TOUR - UPDATED FOR GROUP TOUR STRUCTURE
  const updateTour = async () => {
    ...
    try {
      ...
      // 3) RE-ADD ALL DATA
      // Departures - Group tours with hotel star ratings
      if (departures.length > 0) {
        const formattedDepartures = departures.map(dept => ({
          ...
          adult_price: dept.three_star_twin || 0, // Using 3-star twin as base price
          // 3-Star Hotel Prices
...
if (formData.is_international === 1) {
  ...
  if (touristVisaItems.length > 0 || transitVisaItems.length > 0 || 
    ...
    console.log('📝 Saving visa data for update:', visaData);
...
const createTour = async () => {
    ...
    try {
      ...
      // 2) DEPARTURES BULK - GROUP TOURS WITH HOTEL STAR RATINGS
      if (departures.length > 0) {
        const formattedDepartures = departures.map(dept => ({
          tour_type: 'Group',
          start_date: dept.start_date,
...
const uploadVisaFormFiles = async (tourId, visaForms) => {
  ...
  return (
    <Navbar>
      <Container>
        <h2 className="mb-4">{isEditMode ? 'Edit Group Tour' : 'Add Group Tour'}</h2>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_twin}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_triple}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_child_with_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_child_without_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_infant}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.three_star_single}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          type="number"
                          name="four_star_twin"
                          value={groupDepartureForm.four_star_twin}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.four_star_triple}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.four_star_child_with_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.four_star_child_without_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.four_star_infant}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.four_star_single}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          type="number"
                          name="five_star_twin"
                          value={groupDepartureForm.five_star_twin}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.five_star_triple}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.five_star_child_with_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.five_star_child_without_bed}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.five_star_infant}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
                    ...
                    <Col md={2}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          value={groupDepartureForm.five_star_single}
                          onChange={handleGroupDepartureChange}
                          placeholder="₹"
                        />
                      </Form.Group>
    ...
    <Tab eventKey="tourist" title="Tourist Visa">
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          onChange={(e) => {
            handleTouristVisaChange(e);
            console.log("Tourist Visa Description:", e.target.value);
          }}
                ...
                <td>
                  <div className="d-flex gap-1">
                    <Button
                      ...
                      onClick={() => {
                        editTouristVisa(idx);
                        console.log("Editing Tourist Visa at index:", idx, item);
                      }}
                      title="Edit"
                    >
                      <Pencil size={14} />
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        removeTouristVisa(idx);
                        console.log("Removing Tourist Visa at index:", idx);
                      }}
                      title="Remove"
                    >
                      <Trash size={14} />
    ...
    <Tab eventKey="transit" title="Transit Visa">
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          onChange={(e) => {
            handleTransitVisaChange(e);
            console.log("Transit Visa Description:", e.target.value);
          }}
                ...
                <td>
                  <div className="d-flex gap-1">
                    <Button
                      ...
                      onClick={() => {
                        editTransitVisa(idx);
                        console.log("Editing Transit Visa at index:", idx, item);
                      }}
                      title="Edit"
                    >
                      <Pencil size={14} />
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        removeTransitVisa(idx);
                        console.log("Removing Transit Visa at index:", idx);
                      }}
                      title="Remove"
                    >
                      <Trash size={14} />
    ...
    <Tab eventKey="business" title="Business Visa">
      <Form.Group className="mb-3">
        ...
        <Form.Control
          ...
          onChange={(e) => {
            handleBusinessVisaChange(e);
            console.log("Business Visa Description:", e.target.value);
          }}
                ...
                <td>
                  <div className="d-flex gap-1">
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        editBusinessVisa(idx);
                        console.log("Editing Business Visa at index:", idx, item);
                      }}
                      title="Edit"
                    >
                      <Pencil size={14} />
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        removeBusinessVisa(idx);
                        console.log("Removing Business Visa at index:", idx);
                      }}
                      title="Remove"
                    >
                      <Trash size={14} />
                ...
                <div className="mb-2">
                  <Button 
                    ...
                    onClick={() => {
                      ...
                      console.log("Opening PDF upload for:", item.type);
                    }}
                  >
                  ...
                  <Form.Control
                    ...
                    className="d-none"
                    onChange={(e) => {
                      handleVisaFormFileChange(idx, 'action1', e.target.files[0]);
                      console.log("PDF file selected for", item.type, ":", e.target.files[0]?.name);
                    }}
                  />
                  {item.action1_file && (
              ...
              <td>
                <div className="mb-2">
                  <Button 
                    ...
                    size="sm"
                    onClick={() => {
                      document.getElementById(`word-upload-${idx}`).click();
                      console.log("Opening Word upload for:", item.type);
                    }}
                  >
                  ...
                  <Form.Control
                    ...
                    className="d-none"
                    onChange={(e) => {
                      handleVisaFormFileChange(idx, 'action2', e.target.files[0]);
                      console.log("Word file selected for", item.type, ":", e.target.files[0]?.name);
                    }}
                  />
                  {item.action2_file && (
                    <div className="mt-1 small">
        ...
        <Card.Body>
          <Form.Group>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                handleTouristVisaRemarksChange(e);
                console.log("Tourist Visa Remarks:", e.target.value);
              }}
          ...
          <Form.Group className="mb-3">
            ...
            <div className="d-flex gap-2">
              <Form.Control
                ...
                onChange={(e) => {
                  handleFreeFlowPhotoChange(e);
                  console.log("Free Flow Photo Text:", e.target.value);
                }}
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  console.log("Adding Free Flow Photo Entry:", freeFlowPhotoText);
                }}
                    ...
                    <td>
                      <div className="d-flex gap-1">
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            editFreeFlowPhotoEntry(idx);
                            console.log("Editing Free Flow Photo at index:", idx, item);
                          }}
                          title="Edit"
                        >
                          <Pencil size={14} />
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            removeFreeFlowPhotoEntry(idx);
                            console.log("Removing Free Flow Photo at index:", idx);
                          }}
                          title="Remove"
                        >
                          <Trash size={14} />
                    ...
                    <td>
                      <div className="d-flex gap-1">
                        <Button
                          ...
                          onClick={() => {
                            editPhoto(idx);
                            console.log("Editing Photo at index:", idx, item);
                          }}
                          title="Edit"
                        >
                          <Pencil size={14} />
    ...
    <Tab eventKey="fees" title="Visa Fees">
      <div className="mb-3">
        <Button 
          ...
          onClick={() => {
            addVisaFeesRow();
            console.log("Adding new Visa Fees row");
          }}
        >
          + Add Free Flow Entry
        </Button>
            ...
            <tr key={row.id}>
              <td>
                <Form.Control
                  ...
                  value={row.tourist}
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'tourist', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Tourist:`, e.target.value);
                  }}
              ...
              <td>
                <Form.Control
                  ...
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'tourist_charges', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Tourist Charges:`, e.target.value);
                  }}
              ...
              <td>
                <Form.Control
                  ...
                  value={row.transit}
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'transit', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Transit:`, e.target.value);
                  }}
                  placeholder="Free flow entry"
                  size="sm"
                />
              ...
              <td>
                <Form.Control
                  ...
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'transit_charges', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Transit Charges:`, e.target.value);
                  }}
              ...
              <td>
                <Form.Control
                  ...
                  value={row.business}
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'business', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Business:`, e.target.value);
                  }}
                  placeholder="Free flow entry"
                  size="sm"
                />
              ...
              <td>
                <Form.Control
                  ...
                  onChange={(e) => {
                    handleVisaFeesChange(row.id, 'business_charges', e.target.value);
                    console.log(`Visa Fees Row ${row.id} - Business Charges:`, e.target.value);
                  }}
              ...
              <td>
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    removeVisaFeesRow(row.id);
                    console.log("Removing Visa Fees Row ID:", row.id);
                  }}
                  title="Remove"
    ...
    <Tab eventKey="submission" title="Submission & Pick Up">
      <div className="mb-3">
        <Button 
          ...
          onClick={() => {
            addSubmissionRow();
            console.log("Adding new Submission row");
          }}
        >
          + Add Free Flow Entry
        </Button>
            ...
            <tr key={row.id}>
              <td>
                <Form.Control
                  ...
                  value={row.label}
                  onChange={(e) => {
                    handleSubmissionLabelChange(row.id, e.target.value);
                    console.log(`Submission Row ${row.id} - Label:`, e.target.value);
                  }}
              ...
              <td>
                <Form.Control
                  ...
                  value={row.tourist}
                  onChange={(e) => {
                    handleSubmissionValueChange(row.id, 'tourist', e.target.value);
                    console.log(`Submission Row ${row.id} - Tourist:`, e.target.value);
                  }}
              ...
              <td>
                <Form.Control
                  ...
                  value={row.transit}
                  onChange={(e) => {
                    handleSubmissionValueChange(row.id, 'transit', e.target.value);
                    console.log(`Submission Row ${row.id} - Transit:`, e.target.value);
                  }}
                  placeholder="Free flow alphanumeric"
                  size="sm"
                />
              ...
              <td>
                <Form.Control
                  ...
                  value={row.business}
                  onChange={(e) => {
                    handleSubmissionValueChange(row.id, 'business', e.target.value);
                    console.log(`Submission Row ${row.id} - Business:`, e.target.value);
                  }}
                  placeholder="Free flow alphanumeric"
                  size="sm"
                />
              ...
              <td>
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    removeSubmissionRow(row.id);
                    console.log("Removing Submission Row ID:", row.id);
                  }}
                  title="Remove"
                >
                  <Trash size={14} />
